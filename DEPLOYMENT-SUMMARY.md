...
### ⚠️ Выберите вашу ситуацию:

#### Вариант А: Чистый сервер (рекомендуется)
У вас новый сервер без Nginx или других проектов.
👉 **Следуйте**: `docs/DEPLOYMENT.md` или `docs/QUICK-DEPLOY.md`

#### Вариант Б: Существующий Nginx
На сервере уже установлен Nginx и развернуты другие проекты.
👉 **Следуйте**: `docs/DEPLOYMENT-EXISTING-NGINX.md`
