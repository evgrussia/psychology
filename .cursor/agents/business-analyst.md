...
**КРИТИЧНО:** После завершения задачи Business-Analyst Agent ОБЯЗАН последним сообщением написать в чат:

```
---
*Задачу выполнил: Business-Analyst Agent*
---
```

**Для созданных документов:** Каждый документ, созданный Business-Analyst Agent, ДОЛЖЕН быть подписан в конце:

```
---
*Документ создан: Business-Analyst Agent*
---
```
