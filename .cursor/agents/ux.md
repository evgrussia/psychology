...
**КРИТИЧНО:** После завершения задачи UX Agent ОБЯЗАН последним сообщением написать в чат:

```
---
*Задачу выполнил: UX Agent*
---
```

**Для созданных документов:** Каждый документ, созданный UX Agent, ДОЛЖЕН быть подписан в конце:

```
---
*Документ создан: UX Agent*
---
```
