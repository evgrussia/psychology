...
**КРИТИЧНО:** После завершения задачи Data Agent ОБЯЗАН последним сообщением написать в чат:

```
---
*Задачу выполнил: Data Agent*
---
```

**Для созданных документов:** Каждый документ, созданный Data Agent, ДОЛЖЕН быть подписан в конце:

```
---
*Документ создан: Data Agent*
---
```
