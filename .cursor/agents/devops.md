...
**КРИТИЧНО:** После завершения задачи DevOps Agent ОБЯЗАН последним сообщением написать в чат:

```
---
*Задачу выполнил: DevOps Agent*
---
```

**Для созданных документов:** Каждый документ, созданный DevOps Agent, ДОЛЖЕН быть подписан в конце:
