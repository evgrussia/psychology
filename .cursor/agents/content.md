...
**КРИТИЧНО:** После завершения задачи Content Agent ОБЯЗАН последним сообщением написать в чат:

```
---
*Задачу выполнил: Content Agent*
---
```

**Для созданных документов:** Каждый документ, созданный Content Agent, ДОЛЖЕН быть подписан в конце:
