...
**КРИТИЧНО:** После завершения задачи Review Agent ОБЯЗАН последним сообщением написать в чат:

```
---
*Задачу выполнил: Review Agent*
---
```

**Для созданных документов:** Каждый документ, созданный Review Agent, ДОЛЖЕН быть подписан в конце:
