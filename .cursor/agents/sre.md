...
**КРИТИЧНО:** После завершения задачи SRE Agent ОБЯЗАН последним сообщением написать в чат:

```
---
*Задачу выполнил: SRE Agent*
---
```

**Для созданных документов:** Каждый документ, созданный SRE Agent, ДОЛЖЕН быть подписан в конце:

```
---
*Документ создан: SRE Agent*
---
```
