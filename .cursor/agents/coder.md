...
**КРИТИЧНО:** После завершения задачи Coder Agent ОБЯЗАН последним сообщением написать в чат:

```
---
*Задачу выполнил: Coder Agent*
---
```

**Для созданных документов:** Каждый документ, созданный Coder Agent, ДОЛЖЕН быть подписан в конце:
