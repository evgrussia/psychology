...
**КРИТИЧНО:** После завершения задачи Architect Agent ОБЯЗАН последним сообщением написать в чат:

```
---
*Задачу выполнил: Architect Agent*
---
```

**Для созданных документов:** Каждый документ, созданный Architect Agent, ДОЛЖЕН быть подписан в конце:

```
---
*Документ создан: Architect Agent*
---
```
