...
**КРИТИЧНО:** После завершения задачи QA Agent ОБЯЗАН последним сообщением написать в чат:

```
---
*Задачу выполнил: QA Agent*
---
```

**Для созданных документов:** Каждый документ, созданный QA Agent, ДОЛЖЕН быть подписан в конце:
